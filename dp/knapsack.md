...
> **思路**
>
> 本题数据范围更大 $N=1000, V = 2000$ ，上述暴力算法时间复杂度$O(n^3)$ 接近 $1e9$, 必超时。
> 
> 经典优化：**二进制的优化方式**：
> 
...
> 
>​ $注意：这里不能要 128，因为从 1 加到 128 等于 255 ，而我们只有 200 个当前的物品。$
> 
> 对于一般数进行抽象，再用代码实现。
> 
...
>
> 2. 状态转移：枚举第 $i$ 组物品 选不选，选哪个？ 
> 
>    ==> (1) 不选 (2) 选第 $i$ 组的第 1 个物品,...,第 $k$ 个物品...
> 
>    这个转移的过程很像一根热狗，就叫 “热狗划分法”
> 	
>    1）第 $i$ 组物品不选：$f[i - 1,j]$
> 	
